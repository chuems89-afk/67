...
-- ============================================================
local Steal = {
	AutoStealEnabled=false, StealRadius=55, StealDuration=0.1,
...
-- Fill completes in 0.1 sec, but HalfHoldMin stays 1.3 sec
-- ============================================================
do
	...
	-- drive fill/label with smooth lerp, fill completes in 0.1 sec
